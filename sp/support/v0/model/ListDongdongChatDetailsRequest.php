...
/**
 * ListDongdongChatDetailsRequest Class Doc Comment
 *
 * @category Class
 * @package  com\jd\openapi\apiClient
 * @author   OpenAPI Generator team
 ...
 */
class ListDongdongChatDetailsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListDongdongChatDetailsRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('entry_list', $data ?? [], null);
        $this->setIfExists('page_size', $data ?? [], null);
        $this->setIfExists('start_time', $data ?? [], null);
        $this->setIfExists('sort_by', $data ?? [], null);
        $this->setIfExists('customer_list', $data ?? [], null);
    ...
    */
     ...
     * Sets entry_list
     *
     * @param string[]|null $entry_list entry_list
     *
     * @return self
     */
    public function setEntryList($entry_list)
    {
        if (is_null($entry_list)) {
            throw new \InvalidArgumentException('non-nullable entry_list cannot be null');
        }
     ...
     * Sets customer_list
     *
     * @param string[]|null $customer_list customer_list
     *
     * @return self
     */
    public function setCustomerList($customer_list)
    {
        if (is_null($customer_list)) {
            throw new \InvalidArgumentException('non-nullable customer_list cannot be null');
        }
