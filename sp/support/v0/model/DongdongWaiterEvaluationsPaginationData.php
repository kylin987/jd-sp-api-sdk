<?php
/**
 * DongdongWaiterEvaluationsPaginationData
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DongdongWaiterEvaluationsPaginationData Class Doc Comment
 *
 * @category Class
 * @package  com\jd\openapi\apiClient
 * @author   OpenAPI Generator team
 ...
 */
class DongdongWaiterEvaluationsPaginationData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DongdongWaiterEvaluationsPaginationData';
    ...
    */
    ...
    public function setHasNextPage($has_next_page)
    {
        if (is_null($has_next_page)) {
            array_push($this->openAPINullablesSetToNull, 'has_next_page');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('has_next_page', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
