...
/**
 * WaybillsProductDTO Class Doc Comment
 *
 * @category Class
 * @package  com\jd\openapi\apiClient
 * @author   OpenAPI Generator team
 ...
 */
class WaybillsProductDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WaybillsProductDTO';
    ...
    protected static $openAPITypes = [
        'product_code' => 'string',
        'product_attributes' => '\com\jd\openapi\apiClient\sp\order\v0\model\WaybillsExtendAttributeDTO[]',
        'product_name' => 'string'
    ];
    ...
    */
     ...
     *
     * @param \com\jd\openapi\apiClient\sp\order\v0\model\WaybillsExtendAttributeDTO[]|null $product_attributes product_attributes
     *
     * @return self
     */
