...
/**
 * ListVenderBrandsRequest Class Doc Comment
 *
 * @category Class
 * @package  com\jd\openapi\apiClient
 * @author   OpenAPI Generator team
 ...
 */
class ListVenderBrandsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListVenderBrandsRequest';
    ...
    */
     ...
     * Sets query_type
     *
     * @param int|null $query_type query_type
     *
     * @return self
     */
    public function setQueryType($query_type)
    {
        if (is_null($query_type)) {
            array_push($this->openAPINullablesSetToNull, 'query_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('query_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
