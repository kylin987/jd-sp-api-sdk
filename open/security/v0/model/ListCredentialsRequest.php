...
/**
 * ListCredentialsRequest Class Doc Comment
 *
 * @category Class
 * @package  com\jd\openapi\apiClient
 * @author   OpenAPI Generator team
 ...
 */
class ListCredentialsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListCredentialsRequest';
    ...
    */
     ...
     *
     * @param int|null $customer_user_id customer_user_id
     *
     * @return self
     */
    public function setCustomerUserId($customer_user_id)
    {
        if (is_null($customer_user_id)) {
            array_push($this->openAPINullablesSetToNull, 'customer_user_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('customer_user_id', $nullablesSetToNull);
            if ($index !== FALSE) {
